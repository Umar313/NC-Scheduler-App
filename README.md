...
<aside class="sidebar">
  ...
  <div class="sidebar-section">
    ...
    <div class="nav-item" onclick="navigate('schedule', this)">
    ...
    <div class="nav-item" onclick="navigate('interviews', this)">
  ...
  <div class="sidebar-section">
    ...
    <div class="nav-item" onclick="navigate('pipeline', this)">
      <i class="ti ti-hierarchy-2"></i> Pipeline
    </div>
    <div class="nav-item" onclick="navigate('candidates', this)">
  ...
  <div class="sidebar-section">
    ...
    <div class="nav-item" onclick="navigate('ats', this)">
  ...
  <div id="page-dashboard" class="page active">
    <div class="topbar">
      ...
      <div class="topbar-right">
        ...
        <button class="btn btn-primary btn-sm" onclick="navigate('schedule', document.querySelector('.nav-item:nth-child(2)'))">
        ...
        <div>
          <div class="section-header">
            ...
            <div class="section-actions">
              <button class="btn btn-ghost btn-sm" onclick="navigate('interviews', document.querySelectorAll('.nav-item')[3])">View all</button>
            </div>
          </div>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td><button class="btn btn-primary btn-sm" onclick="navigate('schedule', document.querySelector('.nav-item:nth-child(2)'))"><i class="ti ti-calendar-plus"></i> Schedule</button></td>
            </tr>
            <tr>
